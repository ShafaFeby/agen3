...
//     std::cout << "Dikirim: " << msg->data << std::endl;
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::Publisher receive_pub = nh.advertise<std_msgs::Int32>("/receive_komunikasi", 10);
    // ros::Subscriber reply_sub = nh.subscribe("/send_komunikasi", 10, replyCallback);
    ...
    inet_pton(AF_INET, "192.168.0.99", &serverAddr.sin_addr);
